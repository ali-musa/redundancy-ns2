...
def plot_graphs(exp_nums,filename):
	...
	elif filename.startswith("avgQ"):
		pl.xlabel("Load (%)")
		if filename.startswith("avgQ0_"):
			pl.ylabel("Average Primary Queue Size\nas seen by incoming flows")
		elif filename.startswith("avgQ1_"):
			pl.ylabel("Average Secondary Queue Size\nas seen by incoming flows")
		else:
			pl.ylabel("Average Queue Size\nas seen by incoming flows")
