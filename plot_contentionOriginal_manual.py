...
# exp_num2=str(202)
	...
	with open(log_dir+"exp"+exp_num+"/contentionOriginal_"+str(copy)+"_"+load+"_manual.csv", 'r') as csvfile:
		for line in csvfile:
			lineList = line.split("[")
			...
			pl.ylim([0,20])
			fig.savefig(plot_dir+"/contention/exp"+exp_num+"_"+str(copy)+"_"+load+"_"+server+"_original.png")
			pl.cla()   # Clear axis
			pl.clf()   # Clear figure
